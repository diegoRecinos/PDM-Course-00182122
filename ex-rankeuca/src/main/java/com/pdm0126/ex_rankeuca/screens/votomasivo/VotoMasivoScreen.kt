...
import com.pdm0126.ex_rankeuca.screens.votomasivo.VotoMasivoViewModel
...
@Composable
fun VotoMasivoScreen (
    viewModel: VotoMasivoViewModel = viewModel(),
    onBack: () -> Unit,
    onNewVote: () -> Unit
){
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                ...
                title = { Text("RankeUca - Voto Masivo") },
            )
        },
        bottomBar = {
            Button(
